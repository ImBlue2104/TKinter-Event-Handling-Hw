...
Label(root, text="Enter Length in Inches to conver to Centimeters:", fg='black', bg='#d0efff').pack()
...
def display():
    ...
    l = int(Length.get())
    Message = Label(root, text = f"{l} inches is equal to {convert(l)} centimeters!", fg = 'white', bg ='blue')
    Message.pack()
